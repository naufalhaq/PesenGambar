...
<html lang="en">
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light fixed-top" id="mainNav">
      <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="#page-top">Pesen Gambar</a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#services">Desainer</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#portfolio">Produk</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#contact">Foto</a>
            </li>
            <li class="nav-item">
              <a class="nav-link js-scroll-trigger" href="#contact">Kompetisi</a>
            </li>
            <li class="nav-item">
        ...
        <div class="row">
          <div class="col-lg-10 mx-auto">
            <h1 class="text-uppercase">
              <strong>SEMUA DESAIN YANG ANDA BUTUHKAN ADA DISINI!</strong>
            </h1>
            <hr>
          </div>
          <div class="col-lg-8 mx-auto">
            <p class="text-faded mb-5">TEMUKAN DESAINER FAVORIT ANDA DAN BEKERJA SAMA DENGAN MEREKA</p>
            <a class="btn btn-primary btn-xl js-scroll-trigger" href="#about">FIND DESAINER</a>
          </div>
        </div>
      </div>
    </header>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto text-center">
            <h2 class="section-heading text-white">Kebutuhan Anda Ada Disini</h2>
            <hr class="light my-4">
            <p class="text-faded mb-4">Posting Kebutuhan Anda Dan Biarkan Desainer Memberikan Solusi</p>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading">Produk Terbaik Untuk Kebutuhan Anda</h2>
            <hr class="my-4">
          </div>
        </div>
      </div>
